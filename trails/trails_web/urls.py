...
from .views import home, category_trails, trail_detail, add_review, like_trail, user_profile, update_profile, update_favorite_trail, category_list, add_trail_to_category
app_name = "trails_web"
